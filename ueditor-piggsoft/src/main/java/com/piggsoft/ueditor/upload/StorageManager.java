...
public class StorageManager {
	...
	private StorageSuccessCallBack storageSuccessCallBack;
	...
	public State saveBinaryFile(byte[] data, String path) {
		...
		state = storageSuccessCallBack.storageCallBack(file);
		return state;
	}
	...
	private State saveTmpFile(File tmpFile, String path) {
		...
		state = storageSuccessCallBack.storageCallBack(targetFile);
	...
	public StorageSuccessCallBack getStorageSuccessCallBack() {
		return storageSuccessCallBack;
	}

	public void setStorageSuccessCallBack(
			StorageSuccessCallBack storageSuccessCallBack) {
		this.storageSuccessCallBack = storageSuccessCallBack;
	}
}
